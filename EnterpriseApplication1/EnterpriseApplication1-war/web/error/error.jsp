<%-- 
    Document   : NotFound
    Created on : 8 Aug, 2022, 9:22:38 PM
    Author     : sunny
--%>
...
<html>
    <head>
        ...
        <title>Error | EPDA Online Booking System</title>
        ...
        <style>
            body {
                background-image: url("https://myclouddoor.com/wp-content/uploads/2016/07/h-under-maintenance-background-1.jpg");
