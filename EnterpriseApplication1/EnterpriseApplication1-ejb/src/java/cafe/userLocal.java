...
public interface userLocal {
    ...
    String updateinfo(int userid, String role, String name, int age, String phone, Date datejoined, int salary, String studentid) throws SQLException;

    String addcustomer(String username, String pass1, String pass2, String name, String studentid, int age, String phone, Date datejoined) throws SQLException;
    
    String addstaff(String username, String pass1, String pass2, String name, int salary, int age, String phone, Date datejoined) throws SQLException;
